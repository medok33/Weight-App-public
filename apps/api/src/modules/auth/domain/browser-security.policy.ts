/**
 * Browser security policy: APP_ENV, CORS allowlist, session cookie flags.
 * Canonical shared copy also lives in packages/config/src/browser-security.ts
 * (ARCH-SEC-02A). API runtime uses this CJS-safe module directly.
 */
