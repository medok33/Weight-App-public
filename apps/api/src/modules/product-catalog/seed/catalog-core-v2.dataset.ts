...
const EXPANSION: Compact[] = [
  ...
  { n: 21, key: 'hard_cheese_45pct', name: 'Сыр твёрдый 45%', cat: 'dairy', form: 'READY_TO_EAT', cal: 363, p: 23, f: 30, c: 0.5, fatPct: 45, allergen: 'milk', role: 'MAIN_PROTEIN', veg: true, review: true, aliases: ['твёрдый сыр'] },
  ...
  { n: 41, key: 'bell_pepper_raw', name: 'Перец болгарский', cat: 'vegetables', form: 'RAW', cal: 27, p: 1, f: 0.3, c: 6.3, role: 'VEGETABLE_BASE', vegan: true, aliases: ['красный сладкий перец'] },
  ...
  { n: 48, key: 'green_beans_raw', name: 'Стручковая фасоль', cat: 'vegetables', form: 'RAW', cal: 31, p: 1.8, f: 0.2, c: 7, role: 'VEGETABLE_BASE', vegan: true, aliases: ['фасоль стручковая'] },
  // fruits
  ...
  // technological
  { n: 73, key: 'wheat_flour', name: 'Мука пшеничная', cat: 'technological_ingredients', form: 'DRY', cal: 364, p: 10, f: 1, c: 76, allergen: 'gluten', role: 'BINDER', veg: true, aliases: ['пшеничная мука'] },
  ...
  { n: 90, key: 'wheat_bread', name: 'Хлеб пшеничный', cat: 'grains', form: 'BAKED', cal: 265, p: 9, f: 3.2, c: 49, allergen: 'gluten', role: 'STARCH', veg: true, review: true, aliases: ['батон', 'белый хлеб'] },
  { n: 91, key: 'oatmeal_dry', name: 'Овсяная крупа', cat: 'grains', form: 'DRY', cal: 389, p: 17, f: 7, c: 66, role: 'STARCH', vegan: true, review: true },
  { n: 92, key: 'semolina_dry', name: 'Манная крупа', cat: 'grains', form: 'DRY', cal: 360, p: 10, f: 1, c: 73, allergen: 'gluten', role: 'STARCH', veg: true, src: 'rf', review: true, aliases: ['манка', 'крупа манная'] },
