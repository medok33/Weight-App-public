...
import { aggregateResearchFacts, buildDishConceptCluster, buildSynthesisBrief, selectCanonicalDonor, type ResearchCandidate, type SynthesisBrief } from '../src/modules/recipe-platform/domain/recipe-knowledge-synthesis.policy.ts';
